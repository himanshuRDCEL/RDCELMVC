                    ...
                    else
                    {
                        ...
                        if (productOrderResponseDC != null && productOrderResponseDC.OrderId > 0 && !string.IsNullOrEmpty(productOrderResponseDC.RegdNo))
                        {
                            if (exchangeDataContract.IsDifferedSettlement == false)
                            {
                                ...
                                {
                                    message = "Your Exchange details have been received at Digi2L.Our product registration referance no. " + exchangeDataContract.RegdNo + ". Our quality check team will connect with you soon.";
                                }
                                else
                                {
        ...
        public ActionResult CustomerDetails(ExchangeOrderDataContract ExchangeObj)
        {
            ...
            try
            {
                if (ExchangeObj != null)
                {
                    ...
                    if (productOrderResponseDC != null)
                        message = "Your product details have been received at Digi2L for reference no is " + ExchangeObj.RegdNo + ". Our quality check team will soon knock at your door.";
                    else
                    {
                        message = "Order not Created";
                        return RedirectToAction("DetailsFailedResponse", "Exchange", new { Message = message });
