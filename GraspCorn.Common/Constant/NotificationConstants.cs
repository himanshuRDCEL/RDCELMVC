...
namespace GraspCorn.Common.Constant
{
    public class NotificationConstants
    {
        ...
        public const string SMS_Order_Recive_Confirmation_MyGate = "Dear Customer - Congratulations on your Smart Sell with Rocking Deals. You are one step closer to getting the best price for your preowned appliance. Order [RegNO] has been placed with Rocking Deals. Our Quality Check expert will be knocking at your door on [Date] at [Time]. By UTC Digital Technologies.";
        public const string SMS_FeedBack = "Dear Customer - Thanks for choosing Rocking Deals. Please click the link [FBLink] to share your experience. By UTC Digital Technologies.";
        ...
        public const string SMS_VoucherGeneration_OTP = "Dear Customer - OTP for voucher generation for the [STORENAME] is  [OTP] by Team Rocking Deals";
        public const string SMS_VoucherVerification_OTP = "Dear Customer - OTP for [STORENAME] voucher verification is [OTP] by Team Rocking Deals.";
        ...
        public const string SMS_PineLabs_CustomerDetailsNew = "Dear Customer - We are in receipt of your Exchange order through Pine Labs with Ref No. [REGNO]. Kindly fill your personal details by clicking on this link [PLink]. Thank You, Team Rocking Deals.";
        ...
        public const string SMS_PineLabs_CustomerDetailsNew1 = "Dear Customer - We are in receipt of your Exchange order through Pine Labs with Ref No. [REGNO]. Kindly fill your personal details by clicking on this link [PLink]. Thank You, Team Rocking Deals.";
       ...
       // public const string SMS_ExchangeOtp = "Dear Customer - OTP for [BrandName] Exchange Program registration is [OTP] by Team Rocking Deals.";
        public const string SMS_ExchangeOtp = "Dear Customer - OTP for [BrandName] voucher verification is [OTP] by Team ROCKINGDEALS.";
