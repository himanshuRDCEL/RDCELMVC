...
namespace RDCEL.DocUpload.BAL.zaakpay
{
    ...
    public static class ChecksumCalculator
    {
        ...
        public static string calculateChecksum(string secretkey, string allparamvalues)
        {
            ...
            //string Base64string = Convert.ToBase64String(checksumByte);
            //<summary>code to convert byte to hexadecimal form.
        ...
        private static string getHashedString(string inputValue)
        {
            ...
            //Code added to convert byte to base 64 sstring
            //string encrypted = Convert.ToBase64String(array);

            //code to return base64 string 
            //return encrypted;

            //<summary>Commented code to return hashstring<summary>
